...
- En cada registro se debe documentar:
  1. Fecha (`YYYY-MM-DD`).
  2. Título del cambio o función implementada.
  3. Descripción detallada punto por punto de las modificaciones realizadas.
  4. Archivos creados o modificados (`HTML`, `PHP`, `CSS`, `JS`, `SQL`).
